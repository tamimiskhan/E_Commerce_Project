...
public class SettingsActivity extends AppCompatActivity {
    ...
    //TODO: VIDEO 19 user can change his information
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        securityQuestionBtn = findViewById(R.id.security_question_btn);//TODO:39 video come from Reset password


        userInfoDisplay(profileImageView, fullNameEditText, userPhoneEditText, addressEditText);

        securityQuestionBtn.setOnClickListener(new View.OnClickListener() {//TODO:39 video come from Reset password go to login activity
            @Override
